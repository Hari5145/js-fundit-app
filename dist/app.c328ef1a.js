...
searchForm.addEventListener("submit", function (e) {
  ...
  var sortBy = document.querySelector('[name="sortby"]:checked').value;
  ...
  _redditapi.default.search(searchTerm, sortBy, searchLimit).then(function (results) {
    var output = '<div class="card-column">';
    results.forEach(function (post) {
      var image = post.preview ? post.preview.images[0].source.url : "https://smirknewmedia.com/wp-content/uploads/2018/03/snoo.jpg";
